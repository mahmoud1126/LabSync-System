            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav mx-auto gap-1">
                    ...
                    <?php if ($userRole === 'faculty_pi'): ?>
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom <?= isActive('pi', $currentPage) ?>"
                                href="/LabSync-System/pi">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom <?= isActive('pi-requests', $currentPage) ?>"
                                href="/LabSync-System/pi/requests">Requests</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom <?= isActive('grants', $currentPage) ?>"
                                href="/LabSync-System/grants">Grants</a>
                        </li>
                    <?php else: ?>
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom <?= isActive('dashboard', $currentPage) ?>"
                                href="/LabSync-System/dashboard">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom <?= isActive('equipment', $currentPage) ?>"
                                href="/LabSync-System/equipment">Equipment</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link nav-link-custom <?= isActive('bookings', $currentPage) ?>"
                                href="/LabSync-System/bookings">Bookings</a>
                        </li>
                        <li class="nav-item">
